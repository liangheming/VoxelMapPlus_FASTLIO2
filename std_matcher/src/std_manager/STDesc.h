...
typedef struct ConfigSetting
{
  ...
  double proj_image_resolution_ = 0.25;
  double proj_dis_min_ = 0.0;
  double proj_dis_max_ = 5;
  double corner_thre_ = 10.0;

  /* for STD */
  int descriptor_near_num_ = 15;
  double descriptor_min_len_ = 2.0;
  double descriptor_max_len_ = 30.0;
  double non_max_suppression_radius_ = 2.0;
